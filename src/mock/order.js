...
} = require('../utils/createOrderNo.js')
    ...
    let list = [
        ...
        }, //
        {
            "product_list": [{
                ...
                "count": 1,
                "main_image": "http:\/\/saidad.oss-cn-guangzhou.aliyuncs.com\/image\/70dfadbd79359a99811c2c2b6f592e4c.jpeg",
                "carriage": "0.90",
            }],
...
let resCreateOrder = (request, response) => {
    const server_order_no = create_server_order_no()
    let result = {
        "errorCode": 0,
        "errorMessage": "success",
        "server_order_number": server_order_no,
        "success": true
    }
    response.json(result)
}
...
let resOrderDetailData = (request, response) => {
    ...
    //客户端将点击的商品的order_id传过来，服务端获取点击的商品的order_id
